...
func (g *Generator) getCCTemplate(f *descriptor.File) (string, error) {
	...
	pkgs := [][]string{
		...
		{"github.com/optherium/cckit/gateway", "cckit_gateway"},
		{"github.com/optherium/cckit/gateway/service", "cckit_ccservice"},
		{"github.com/optherium/cckit/router", "cckit_router"},
		{"github.com/optherium/cckit/router/param/defparam", "cckit_defparam"},
		{"github.com/optherium/cckit/router/param", "cckit_param"},
	}
